...
// Claims reperesents the authorization claims transmitted via jwt.
type Claims struct {
...
// private and public keys for jwt use. The return could be
// a PEM encoded string or JWS based key
